...
public class GPUFitterTest {
	...
	public void setUp() throws Exception {
		...
		File file = new File("H:\\ownCloud\\exp-images.tif");
		...
		AbstractModule peak = new NMSDetector(15,5,0); //
		//AbstractModule peak = new DoGFinder(4.5f,13); //DRG_KO_5_1.tif
		//AbstractModule peak = new NMSDetector(2000,5); //DRG_WT_MT_A647_1.tif
		AbstractModule fitter = new MLE_Fitter<>(5,1152*8);
		AbstractModule saver = new SaveLocalizations(new File(System.getProperty("user.home")+"/ownCloud/exp-images.csv"));
