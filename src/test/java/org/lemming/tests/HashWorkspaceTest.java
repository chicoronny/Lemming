...
public class HashWorkspaceTest extends HashWorkspace {
	...
	public void testCopy() {
		...
		h1.addRow(h.getGenericRow(0));
		
		assertEquals(h1.getGenericRow(0).getX(), 1, 1e-3);
	}
	...
	public void testCopyConstr() {
		...
		assertEquals(h2.getGenericRow(0).getX(), 2, 1e-3);
	}
	...
	public void testRemove() {
		...
		assertEquals(h.getGenericRow(0).getX(), 2, 1e-3);
		assertEquals(h.getNumberOfRows(), 1);
	}
